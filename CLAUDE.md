...
2. **EmailForge** (`/products/email-forge`) — 5-email sequence generator (AIDA/PAS/Hormozi/Cialdini/Story)
3. **AudienceDecoder** (`/products/audience-decoder`) — Audience archetype + engagement analysis
