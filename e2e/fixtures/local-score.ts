/** Pre-generated test documents (one per LocalScore analysis mode) */
...
/** Mock AI responses (what the "engine" returns per mode) */
...
/** Mode IDs and their button labels on the UI */
export const MODE_LABELS: ReadonlyArray<readonly [string, string]> = [
