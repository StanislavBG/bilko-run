import{u as c,j as e}from"./index-CuSItVEA.js";const u={slug:"rules-vs-learning",moduleSlug:"what-is-an-ai",courseSlug:"foundations",title:"The 60-year shift — from rules to learning",tagline:'Why "AI" looked like a chess engine for 50 years and a chatbot in the last 3.',estimatedMinutes:12,objectives:[{statement:'Explain in one sentence the difference between "symbolic AI" and "machine-learning AI".'},{statement:"Place LLMs on a 60-year timeline of AI techniques."},{statement:'Recognize why most "expert systems" failed and what replaced them.'}],sources:[{label:"MIT 6.034 — Patrick Winston (Fall 2010), Lecture 1: Introduction and Scope",url:"https://ocw.mit.edu/courses/6-034-artificial-intelligence-fall-2010/resources/lecture-1-introduction-and-scope/",retrievedOn:"2026-05-09"},{label:"MIT 6.S191 — Lecture 1: Intro to Deep Learning",url:"https://introtodeeplearning.com/",retrievedOn:"2026-05-09"}],prerequisites:["what-this-course-is"],publishedOn:"2026-05-09"};function d(n){const t={em:"em",h2:"h2",li:"li",p:"p",ul:"ul",...c(),...n.components},{Figure:i,Meter:r,Quiz:o,Steps:l,Term:s,TokenizerDemo:h}=t;return i||a("Figure"),r||a("Meter"),o||a("Quiz"),l||a("Steps"),s||a("Term"),h||a("TokenizerDemo"),e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The first AI that impressed a room was a program called SHRDLU, and it moved blocks.[1]"}),`
...
hand; the `,e.jsx(s,{word:"training",children:"training"})," process found them."]}),`
`,e.jsx(i,{caption:"Fig 05.1 — two ways to get to an output: hand-written rules vs. learned weights",children:e.jsxs("svg",{viewBox:"0 0 600 240",style:{maxWidth:"100%",height:"auto"},role:"img","aria-label":"Top path: a human writes if-then rules that produce an output. Bottom path: data and examples feed a training process that produces learned weights, which produce an output.",children:[e.jsx("text",{x:"20",y:"30",className:"dg-label",children:"Symbolic AI"}),e.jsx("rect",{x:"20",y:"42",width:"150",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"95",y:"68",textAnchor:"middle",className:"dg-mono",children:"if / else rules"}),e.jsx("line",{x1:"170",y1:"64",x2:"250",y2:"64",className:"dg-line"}),e.jsx("path",{d:"M250 64 l-9 -4 v8 z",className:"dg-fill-ink"}),e.jsx("rect",{x:"250",y:"42",width:"150",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"325",y:"68",textAnchor:"middle",className:"dg-strong",children:"written by hand"}),e.jsx("line",{x1:"400",y1:"64",x2:"480",y2:"64",className:"dg-line"}),e.jsx("path",{d:"M480 64 l-9 -4 v8 z",className:"dg-fill-ink"}),e.jsx("rect",{x:"480",y:"42",width:"100",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"530",y:"68",textAnchor:"middle",className:"dg-strong",children:"output"}),e.jsx("text",{x:"20",y:"158",className:"dg-label",children:"Machine learning"}),e.jsx("rect",{x:"20",y:"170",width:"150",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"95",y:"196",textAnchor:"middle",className:"dg-mono",children:"data + examples"}),e.jsx("line",{x1:"170",y1:"192",x2:"250",y2:"192",className:"dg-line-accent"}),e.jsx("path",{d:"M250 192 l-9 -4 v8 z",className:"dg-fill-accent"}),e.jsx("rect",{x:"250",y:"170",width:"150",height:"44",rx:"6",className:"dg-box-accent"}),e.jsx("text",{x:"325",y:"190",textAnchor:"middle",className:"dg-strong",children:"training"}),e.jsx("text",{x:"325",y:"206",textAnchor:"middle",className:"dg-label",children:"finds the rules"}),e.jsx("line",{x1:"400",y1:"192",x2:"480",y2:"192",className:"dg-line-accent"}),e.jsx("path",{d:"M480 192 l-9 -4 v8 z",className:"dg-fill-accent"}),e.jsx("rect",{x:"480",y:"170",width:"100",height:"44",rx:"6",className:"dg-box-accent"}),e.jsx("text",{x:"530",y:"196",textAnchor:"middle",className:"dg-strong",children:"output"})]})}),`
...
`,e.jsx(l,{items:[{title:"Large labeled datasets",body:"Enough examples — eventually billions — for the patterns to be statistically findable."},{title:"Backpropagation at scale",body:"Efficient algorithms for propagating errors back through a network to adjust its weights."},{title:"Fast-enough hardware",body:"GPUs that made the arithmetic practical — the three converged in the early 2010s."},{title:"ImageNet 2012",body:"A deep network halved the previous error rate on a major benchmark, and the field changed gears."}]}),`
...
`,e.jsxs(t.h2,{children:["Where ",e.jsx(s,{word:"LLM",children:"LLMs"})," fit"]}),`
...
written about.`}),`
`,e.jsx(r,{rows:[{label:"SHRDLU — hand-written lines of code",value:1,display:"~10k"},{label:"Modern LLM — learned parameters",value:100,display:"hundreds of billions",alt:!0}]}),`
`,e.jsxs(t.h2,{children:["See it in the ",e.jsx(s,{word:"token",children:"tokens"})]}),`
...
`,e.jsx(h,{defaultText:"An AI used to be 50 lines of rules."}),`
...
https://introtodeeplearning.com/ (retrieved 2026-05-09).`]})]})}function p(n={}){const{wrapper:t}={...c(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(d,{...n})}):d(n)}function a(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default,u as frontmatter};
