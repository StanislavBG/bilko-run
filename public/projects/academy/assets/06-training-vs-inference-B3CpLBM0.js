...
`,e.jsx(i,{caption:"Fig 06.1 — training writes the weights once; inference reads them every time",children:e.jsxs("svg",{viewBox:"0 0 600 240",style:{maxWidth:"100%",height:"auto"},role:"img","aria-label":"Two-phase diagram: training feeds an enormous corpus into a slow, one-time process that adjusts billions of weights and freezes them; inference takes your prompt, runs it through the frozen weights, and returns output quickly on every request.",children:[e.jsxs("text",{x:"20",y:"28",className:"dg-strong",children:[e.jsx(o,{word:"training",children:"TRAINING"})," — once, slow, expensive"]}),e.jsx("rect",{x:"20",y:"44",width:"130",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"85",y:"66",textAnchor:"middle",className:"dg-label",children:"huge corpus"}),e.jsx("text",{x:"85",y:"80",textAnchor:"middle",className:"dg-mono",children:"books · web · code"}),e.jsx("line",{x1:"150",y1:"66",x2:"208",y2:"66",className:"dg-line"}),e.jsx("path",{d:"M208 66 l-9 -4 v8 z",className:"dg-fill-ink"}),e.jsx("rect",{x:"210",y:"44",width:"150",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"285",y:"66",textAnchor:"middle",className:"dg-label",children:"adjust billions"}),e.jsx("text",{x:"285",y:"80",textAnchor:"middle",className:"dg-mono",children:"of weights"}),e.jsx("line",{x1:"360",y1:"66",x2:"418",y2:"66",className:"dg-line"}),e.jsx("path",{d:"M418 66 l-9 -4 v8 z",className:"dg-fill-ink"}),e.jsx("rect",{x:"420",y:"44",width:"160",height:"44",rx:"6",className:"dg-box-accent"}),e.jsx("text",{x:"500",y:"66",textAnchor:"middle",className:"dg-strong",children:"frozen weights"}),e.jsx("text",{x:"500",y:"80",textAnchor:"middle",className:"dg-mono",children:"snapshot, locked"}),e.jsx("line",{x1:"20",y1:"118",x2:"580",y2:"118",className:"dg-line"}),e.jsxs("text",{x:"20",y:"156",className:"dg-strong",children:[e.jsx(o,{word:"inference",children:"INFERENCE"})," — every request, fast"]}),e.jsx("rect",{x:"20",y:"172",width:"130",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"85",y:"199",textAnchor:"middle",className:"dg-mono",children:"your prompt"}),e.jsx("line",{x1:"150",y1:"194",x2:"208",y2:"194",className:"dg-line-accent"}),e.jsx("path",{d:"M208 194 l-9 -4 v8 z",className:"dg-fill-accent"}),e.jsx("rect",{x:"210",y:"172",width:"150",height:"44",rx:"6",className:"dg-box-accent"}),e.jsx("text",{x:"285",y:"194",textAnchor:"middle",className:"dg-label",children:"frozen weights"}),e.jsx("text",{x:"285",y:"208",textAnchor:"middle",className:"dg-mono",children:"unchanged"}),e.jsx("line",{x1:"360",y1:"194",x2:"418",y2:"194",className:"dg-line-accent"}),e.jsx("path",{d:"M418 194 l-9 -4 v8 z",className:"dg-fill-accent"}),e.jsx("rect",{x:"420",y:"172",width:"160",height:"44",rx:"6",className:"dg-box"}),e.jsx("text",{x:"500",y:"199",textAnchor:"middle",className:"dg-strong",children:"output"})]})}),`
`,e.jsx(n.h2,{children:"The training step"}),`
...
and it is a property of training, not of inference. Anthropic publishes
...
`,e.jsx(l,{stats:[{num:"Once vs every",label:"Training happens one time; inference runs on every message"},{num:"Months vs <1s",label:"Training takes months; first tokens can arrive in under a second"},{num:"Weights vs none",label:"Training changes billions of weights; inference changes nothing"}]}),`
...
over that data.[4]`}),`
`,e.jsx(d,{items:[{title:"Call a tool",body:"During inference, the model invokes an external function — a web search, a database query, a live feed."},{title:"Fetch fresh data",body:"The tool runs outside the model and returns a result that is newer than the training cutoff."},{title:"Place it in context",body:"The result is dropped into the context window — to the model, just more text it can read."},{title:"Reason and reply",body:"The frozen weights reason over the fresh data and generate the answer. No weights changed."}]}),`
...
`,e.jsx(a,{id:"m1l6-r1",prompt:"Think of a question you asked Claude in the last week where freshness mattered. Was a tool wired in (web search, API call)? If not — would the answer have been better with one?",minChars:40}),`
...
before the model produces its answer.`]})]})}function f(t={}){const{wrapper:n}={...c(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(h,{...t})}):h(t)}function s(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{f as default,m as frontmatter};
