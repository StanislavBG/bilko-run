  ...
  return (
    <section className="card opts-strategy-card">
      ...
      <div style={grid}>
        ...
        {field("Min net credit", `> ${usd2(c.min_net_credit)}`, "the unconditional floor — a candidate whose net credit does not clear this is refused before submission, checked again against the exact price about to be sent to the broker, not just the earlier scan estimate; a fill that slips through anyway pages the operator", "min_net_credit")}
