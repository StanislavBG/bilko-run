...
// EmailForge extracted to ~/Projects/Email-Forge (static-path sibling at /projects/email-forge/).
...
const TABS: Tab[] = [
  // HeadlineGrader, AdScorer, ThreadGrader, EmailForge are now sibling apps — link out instead of rendering inline.
